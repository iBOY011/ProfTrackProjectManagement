...
public class DocumentImpl implements DocumentDAO {
    ...
    public void createDocument(Document document) {
        List<Document> documents = StorageFile.readObjectsFromJsonFile("DocumentFile.json");
        documents.add(document);
        StorageFile.saveToJsonFile(documents, "DocumentFile.json");
    }
     ...
     */
    @Override
    public Document readDocument(int idDocument) {
        List<Document> documents = StorageFile.readObjectsFromJsonFile("DocumentFile.json");
    ...
    public List<Document> getAllDocuments() {
        return StorageFile.readObjectsFromJsonFile("DocumentFile.json");
    }
