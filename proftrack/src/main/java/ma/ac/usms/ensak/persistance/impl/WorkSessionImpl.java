...
public class WorkSessionImpl implements WorkSessionDAO {
     ...
     */
    @Override
    public void createworkSession(WorkSession workSession) {
     ...
     */
    @Override
    public WorkSession readworkSession(int idworkSession) {
        // TODO Auto-generated method stub
    ...
    public void updateworkSession(WorkSession workSession) {
        ...
        StorageFile.saveToJsonFile(workSessions, "workSessionFile.json");
    }
    ...
    public List<WorkSession> getAllSeancesTravail() {
        // TODO Auto-generated method stub
        return StorageFile.readObjectsFromJsonFile("workSessionFile.json");
    }
