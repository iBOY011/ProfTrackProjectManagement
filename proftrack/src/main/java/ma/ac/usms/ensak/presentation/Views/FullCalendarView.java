...
import ma.ac.usms.ensak.presentation.Views.AnchorPaneNode;
...
public class FullCalendarView {
    ...
    public void addMultiDayTask(LocalDate startDate, LocalDate endDate, String taskTitle, String idTask) {
        for (AnchorPaneNode ap : allCalendarDays) {
            if (!ap.getDate().isBefore(startDate) && !ap.getDate().isAfter(endDate)) {
                ap.addTask(taskTitle, idTask);
            }
        }
    }
    ...
    public Button getpreviousMonth() {
